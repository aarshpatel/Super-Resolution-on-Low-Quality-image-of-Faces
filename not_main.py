...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="ThreeLayerCNNBaseline",
    ...
    if opt.model == "ThreeLayerCNNBaseline":
        ...
        model = ResnetSubPixelCNNVariant()
    ...
    for epoch in range(num_epochs):
        ...
        val_loss, val_psnr_avg = validate(val_loader, model, loss_type, epoch, model_name=main_hyperparameters,
                                          vgg_loss=vgg_loss)
